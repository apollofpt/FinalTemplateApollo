                ...
                <div class="container">
                    ...
                    <c:forEach items="${listL}" var="l" >
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                <div class="img1"><img src="${l.thumbnail}" alt=""></div>
                                <div class="img2"><img style="margin-left: -25%;" src="${l.avatar}"
                                                       alt=""></div>
                                <div class="main-text">
                                    <h2>${l.username}</h2>
                                    <h3>${l.title}</h3>
                    ...
                    <div class="col-md-4">
                        <div class="card-container">
                            <div class="card">
                                ...
                                <div class="back">
                                    <div class="product-img"><img src="${t.thumbnail}" alt=""></div>
                                    <div class="main-text">
                                        <div class="main-text-title">
                                            <h3>${t.title}</h3>
                                        </div>
                                        <p class="description">${t.description}
                                        </p>
                                    </div>
                                    <div class="footer">
            ...
            <div class="container">
                <div class="row">                    
                    ...
                    <div class="col-md-8 the-left-card">
                        <div class="row">
                            <c:forEach items="${listAl}" end="1" var="al" varStatus="count">
                                <c:if test="${count.index == 1}" >
                                    <div class="card no-gutters" style="position: absolute; left: 0; bottom: 0;" >
                                    </c:if>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 px-0">
                                                <div class="product-img">
                                                    <img class="card-img" src="${al.thumbnail}" alt="">
                                                </div>
                                            </div>
                                            <div class="col-md-8 px-0">
                                                <div class="card-body">
                                                    <h3 class="card-title mb-0 pb-0">${al.title}</h3>
                                                    <p class="card-text">
                                                        <small><i class="fas fa-clock icon-clock"></i>${al.date}</small>
                                                    </p>
                                                    <div class="like-progress">
                                                        <div class="icon-heart"><i class="fas fa-heart"></i></div>
                                                        <div class="progress w-75" style="height: 5px">
                                                            <div class="progress-bar bg-danger" style="width: ${al.like*100/mostLike}%"
                                                    ...
                                                    <p class="card-text description">${al.description}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>            
                    ...
                    <div class="col-md-4 the-right-card">
                        <c:forEach items="${listAr}" var="ar" >
                            <div class="card">
                                <div class="product-img"><img src="${ar.thumbnail}" alt=""></div>
                                <div class="card-body pb-0 ">
                                    <h2>Nhat Quang LNN</h2>
                                    <h3 class="card-title mb-0 pb-0">${ar.title}</h3>
                                    <p class="card-text">
                                        <small><i class="fas fa-clock icon-clock"></i>${ar.date}</small>
                                    </p>
                                    <div class="like-progress">
                                        <div class="icon-heart"><i class="fas fa-heart"></i></div>
                                        <div class="progress w-75" style="height: 5px">
                                            <div class="progress-bar bg-danger" style="width: ${ar.like*100/mostLike}%" role="progressbar"
                                                 style="width: 100%" aria-valuenow="36" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
                                    <p class="description">${ar.description}</p>
                                </div>
                                <div class="footer">
                                    <div class="footer-to-align-center">
