...
import mail.code;
import mail.withHTML;

/**
 *
 * @author truon
 */
@WebServlet(name = "ValidateEmailServlet", urlPatterns = {"/validateEmail"})
public class ValidateEmailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ValidateEmailServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
